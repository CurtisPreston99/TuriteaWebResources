...
Sandcastle.addToolbarButton('Show Pins', function () {
    ...
    var area = "north=" + Cesium.Math.toDegrees(rect.north).toFixed(6) +
            "&south=" + Cesium.Math.toDegrees(rect.south).toFixed(6) +
            "&east=" + Cesium.Math.toDegrees(rect.east).toFixed(6) +
            "&west=" + Cesium.Math.toDegrees(rect.west).toFixed(6) +
            "&timeBegin=0" +
            "&timeEnd=20000";
    $.getJSON("getPins", area, function (data) {
